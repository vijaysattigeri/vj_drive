        ...
        <body>
                ...
                <nav class="navbar navbar-default navbar-fixed-top">
                    <div class="container-fluid" style="background-color:#0b4a91; font-variant-caps:all-petite-caps;">
                        ...
                        <div class="navbar-collapse collapse" id="resize_menu_vj_top">
                            ...
                            <ul class="nav navbar-nav">
                                <li id="list_id_file_explorer"><a href="file_explorer.php"><span class="glyphicon glyphicon-th-list" style="font-size: 20px; color:white;"></span><span style="font-size: medium;color:#ffffff;">&nbsp; FILE EXPLORER </span></a></li>
                            </ul>
            ...
            <div class="container" style="padding-top: 100px;">
                <form action="upload_script.php" method="post" enctype="multipart/form-data" style="padding:19px 29px 29px;margin: 0 auto;background-color:#f2f2f2; border: 0px solid #080808; border-radius: 5px;box-shadow: 0 1px 70px rgb(0, 0, 0);font-family: Tahoma, Geneva, sans-serif;font-weight: lighter;">
                    <h2 style="color:#0b4a91;">Input file(s) details </h2>
                    <hr>
                    <div class="row">
                        <div class="col-md-4">
                    ...
                    <div class="row">                        
                        <div class="col-md-4">
                            <h4>Enter a short note on these files</h4>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">  
                                <textarea rows="5" cols="50" name="note" placeholder="Enter the note here" required="required" class="form-control" style="padding:20px 20px 20px 20px;"></textarea>
                            </div>
                        </div>
                    </div>   
